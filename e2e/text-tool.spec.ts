...
test.describe('Text tool', () => {
  ...
  test('area text layer stays as text type after commit', async ({ page }) => {
  ...
  test('clicking committed text re-enters edit mode with original text', async ({ page }) => {
    ...
    // Text stays as type 'text' — clicking it re-enters editing for that layer
