...
![The New Document dialog in Lopsy with the Instagram Post preset (1080 × 1080 px) selected](01-new-document.webp)
...
![The Gradient Editor with a deep purple stop on the left and a near-black stop on the right](02-gradient-colors.webp)
...
![The word NEON being typed in pale pink 240 px text, with the Text options bar showing size 240](04-type-text.webp)
...
![The Move tool options bar with the align buttons, and the NEON text centered on the canvas](05-center-text.webp)
...
![Inner Glow enabled in the Layer Effects panel with a pink color, size 14 and opacity 100, giving the letters a bright core and saturated edges](07-inner-glow.webp)
...
![The Export dialog showing a preview of the finished neon sign with PNG format selected](08-export.webp)
