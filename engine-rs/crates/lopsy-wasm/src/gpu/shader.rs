...
pub const RIPPLE_WAVE_FRAG: &str = include_str!("shaders/filters/ripple_wave.glsl");
...
impl ShaderPrograms {
    pub fn compile_all(gl: &WebGl2RenderingContext) -> Result<Self, String> {
        ...
        Ok(Self {
            ...
            ripple_wave: compile_program(gl, v, RIPPLE_WAVE_FRAG)?,
