...
pub const POLAR_COORDINATES_FRAG: &str = include_str!("shaders/filters/polar_coordinates.glsl");
...
pub struct ShaderPrograms {
    ...
    pub polar_coordinates: ShaderProgram,
...
impl ShaderPrograms {
    pub fn compile_all(gl: &WebGl2RenderingContext) -> Result<Self, String> {
        ...
        Ok(Self {
            ...
            polar_coordinates: compile_program(gl, v, POLAR_COORDINATES_FRAG)?,
