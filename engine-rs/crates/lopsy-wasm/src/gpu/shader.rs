...
pub const TILE_OFFSET_FRAG: &str = include_str!("shaders/filters/tile_offset.glsl");
...
impl ShaderPrograms {
    pub fn compile_all(gl: &WebGl2RenderingContext) -> Result<Self, String> {
        ...
        Ok(Self {
            ...
            tile_offset: compile_program(gl, v, TILE_OFFSET_FRAG)?,
